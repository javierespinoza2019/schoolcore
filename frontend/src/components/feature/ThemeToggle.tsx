  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        title="Cambiar tema"
      >
        <i className={iconMap[theme] || 'ri-contrast-2-line'} />
      </button>
      {open && (
        <div className="absolute right-0 top-full mt-1 w-36 bg-background-50 border border-secondary-200 rounded-lg shadow-lg z-50 py-1">
          {options.map((opt) => (
            <button
              key={opt.value}

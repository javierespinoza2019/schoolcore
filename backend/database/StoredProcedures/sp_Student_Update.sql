...
CREATE OR ALTER PROCEDURE dbo.sp_Student_Update
    ...
    @EducationLevelId UNIQUEIDENTIFIER=NULL, @Grade NVARCHAR(20)=NULL, @GroupCode NVARCHAR(10)=NULL,
    @Status NVARCHAR(30), @EnrollmentDate DATE=NULL, @BloodType NVARCHAR(5)=NULL,
    ...
    @LevelName NVARCHAR(100)=NULL, @PhotoUrl NVARCHAR(500)=NULL, @UpdatedBy UNIQUEIDENTIFIER=NULL
AS
BEGIN
    SET NOCOUNT ON;
